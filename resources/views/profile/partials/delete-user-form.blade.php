<section class="space-y-6">
    ...
    <x-bladewind.button x-data="" color="black" can_submit="false" class="mt-3"
        x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')">{{ __('Delete Account') }}</x-bladewind.button>
