<x-app-layout>
    ...
    <div class="p-4 border-gray-200 border-dashed rounded-lg mt-4border-2 dark:border-gray-700">
        ...
        <div class="max-w-6xl mx-auto">
            <form action="{{ route('students.index', ['student' => $eleve]) }}" method="POST" class="p-4 space-y-4 ">
                @csrf
                @method('PATCH')
                ...
                <div class="grid gap-4 grid-col sm:grid-cols-2">
                    ...
                    <div>
                        <!-- nom de l'eleve -->
                        <div>
                            <x-bladewind::input name="nom" required='true' type="text" :value="old('nom', $eleve->nom)"
                        ...
                        <div>
                            <x-bladewind::input name="prenom" required='true' autofocus type="text"
                                :value="old('prenom', $eleve->prenom)" label="Prénom" viewable="true" />
                        ...
                        <div>
                            <x-bladewind::input name="cin" required='true' autofocus type="text"
                                :value="old('cin', $eleve->cin)" label="Numéro de la CIN" viewable="true" />
                        ...
                        <div>
                            <x-bladewind::input name="adresse" required='true' autofocus type="text"
                                :value="old('adresse', $eleve->adresse)" label="Adresse" viewable="true" />
                    ...
                    <div>
                        ...
                        <div>
                            <x-bladewind::input prefix="+212" name="tel" required='true' autofocus type="text"
                                :value="old('tel', str_replace('+212', '', $eleve->tel))" label="Numéro de Télephone" viewable="true" prefix_is_icon="false" />
                        ...
                        <div>
                            <x-bladewind::input name="email" required='true' autofocus type="email"
                                :value="old('email', $eleve->email)" label="Adresse email" viewable="true" prefix="envelope"
                                prefix_is_icon="true" />
                        ...
                        <div>
                            <x-bladewind::select name="filiere" searchable="true" label_key="filiere" value_key="key"
                                multiple="true" :selected_value="old('filiere')" :data="$filieres" />
